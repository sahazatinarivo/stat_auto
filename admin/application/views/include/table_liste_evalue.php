<div class="container-fluid" id="block-creation-table">
	<div id="rech_db">
		<fieldset class="fieldset-new-table">
			...
			<div class="form-content">
				<span>Nom</span>
				<span class="span-nom-table"> st_liste_evalue</span>
	...
	<div id="bas_nv_table">
		<button type="button" id="cree-table-liste" value="liste_evalue">Executer</button>
	</div>
	<hr>
	      	...
	      	<tr>
	        	...
	        	<td class="text-center">
	        		<?php if ($c->Field!=="id" and $c->Field!=="slug") { ?>
	        			<a href="#" class="btn btn-primary btn-sm" id="edite_column_table-<?php echo $c->Field; ?>">
	        				<i class="fa fa-edit"></i>
	        			</a>
	        			<a href="<?php echo base_url(); ?>index.php/drop_column_table?{n}=<?php echo urlencode($c->Field); ?>&&{t}=liste_evalue" class="btn btn-danger btn-sm" onclick="return(confirm('Etes-vous sûr de vouloir supprimer?'));">
